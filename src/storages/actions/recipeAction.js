...
export const sendNotifs = () => async dispatch => {
  ...
  const logoImagePath = Image.resolveAssetSource(require('../../assets/images/icont.png')).uri;

  let data = {
    included_segments: 'Subscribed Users',
    app_id: '0eaa7f7a-d93d-4d98-a3e1-d41ae1125fec',
    headings: {en: 'New Recipe has been added'},
    contents: {en: 'Check it out now!'},
    name: 'RECIPES_ADDED_NOTIFS',
    big_picture: logoImagePath,
  };

  const url = "MTU2OWNmNWEtM2I1OS00YWZmLWIyZGYtNDk5NDA1MWY3M2Y2";
  let config = {
    headers: {
      accept: 'application/json',
      Authorization: `Basic ${url}`,
...
const url_cat = 'https://rich-colt-cuff.cyclic.app/categories/';
